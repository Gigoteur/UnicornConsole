pub mod sound {
    ...
    impl SoundInternal {
        ...
        pub fn new_music(&mut self, cartridge: &mut UnicornCartridge,
                         filename: String) -> i32 {
        /*
            if filename != "" {
        ...
        pub fn new_sfx(&mut self, cartridge: &mut UnicornCartridge,
                       filename: String) -> i32 {
        ...
        pub fn sfx(&mut self, cartridge: &mut UnicornCartridge, _: Arc<Mutex<Sound>>,
