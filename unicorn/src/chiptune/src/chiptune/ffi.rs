...
#[repr(C)]
pub struct MusPattern {
	//pub step: *mut MusStep;
	//Uint16 num_steps;
	//Uint8 color;
}
...
#[repr(C)]
pub struct MusSong {
  pub instrument: *mut MusInstrument,
  pub num_instruments: c_uchar,

}

pub type chiptune_player = *mut c_void;
pub type chiptune_song = *mut MusSong;
...
extern "C" {
  ...
  pub fn Chiptune_PlayMusic(player: chiptune_player, song : chiptune_song,  start_position: c_int);
  ...
  pub fn Chiptune_NewMusic(player: chiptune_player, name: *const c_char) -> chiptune_song;
  pub fn Chiptune_NewSound(player: chiptune_player, name: *const c_char) -> chiptune_sound;
  ...
  pub fn Chiptune_GetInstrument(song : chiptune_song, idx: c_int) -> chiptune_sound;
}
